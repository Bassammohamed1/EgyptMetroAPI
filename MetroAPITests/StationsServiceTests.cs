...
namespace MetroAPI.Tests
{
    ...
    {
        [Fact]
        public void GetStationAsync_WhenIdIsZero_ThrowsArgumentNullException()
        {
            //Arrange
        ...
        [Fact]
        public void AddStation_WhenAddValidStation_AddStationSuccessfully()
        {
            //Arrange
            var context = new InMemoryDB();
        ...
        [Fact]
        public void UpdateStation_WhenUpdateValidStation_UpdateStationSuccessfully()
        {
            //Arrange
            var context = new InMemoryDB();
            var station = new Station()
        ...
        [Fact]
        public void DeleteStation_WhenDeleteValidStation_DeleteStationSuccessfully()
        {
            //Arrange
            var context = new InMemoryDB();
            var station = new Station()
        ...
        [Fact]
        public void GetStationLineAsync_WhenInvalidStation_ReturnNoData()
        {
            //Arrange
            var context = new InMemoryDB();
            var sut = new StationsService(context, null);
            ...
            //Act
            var result = sut.GetStationLineAsync("Test");
        ...
        [Fact]
        public void GetDistanceAsync_WhenValidInputs_ReturnDistance()
        {
            //Arrange
            var context = new InMemoryDB();
            var sut = new StationsService(context, null);
            ...
            //Act
            var result = sut.GetDistanceAsync(30.12, 29.20, 31.118, 30.0157);
        ...
        [Fact]
        public void GetDistanceAsync_WhenInputsIsZero_ReturnZero()
        {
            //Arrange
            var context = new InMemoryDB();
            var sut = new StationsService(context, null);
            ...
            //Act
            var result = sut.GetDistanceAsync(0, 0, 0, 0);
        ...
        [Fact]
        public void GetDistanceAsync_WhenInputsAreEqual_ReturnZero()
        {
            //Arrange
            var context = new InMemoryDB();
            var sut = new StationsService(context, null);
            ...
            //Act
            var result = sut.GetDistanceAsync(30.12, 29.20, 30.12, 29.20);
            var expected = 0;
        ...
        [Fact]
        public void Deg2RadAsync_WhenValidInput_ReturnDeg2Rad()
        {
            //Arrange
            var context = new InMemoryDB();
            var sut = new StationsService(context, null);
            ...
            //Act
            var result = sut.Deg2RadAsync(50.16);
        ...
        [Fact]
        public void Deg2RadAsync_WhenInputIsZero_ReturnZero()
        {
            //Arrange
            var context = new InMemoryDB();
            var sut = new StationsService(context, null);
        ...
        [Fact]
        public void GetSharedStationsAsync_WhenThereIsSharedStations_ReturnSharedStations()
        {
            //Arrange
            var context = new InMemoryDB();
            ...
            //Act
            var result = sut.GetSharedStationsAsync(1, 2);
        ...
        [Fact]
        public void GetSharedStationsAsync_WhenThereIsNoSharedStations_ReturnNoData()
        {
            //Arrange
            var context = new InMemoryDB();
        ...
        [Fact]
        public void FindStationByNameAsync_WhenThereIsNoStations_ReturnNoData()
        {
            //Arrange
            var context = new InMemoryDB();
            var sut = new StationsService(context, null);
            ...
            //Act
            var result = sut.FindStationByNameAsync("Test");
        ...
        [Fact]
        public void GetPathAsync_WhenTheStationsIsInTheSameLineAndTheFromStationIsBeforeTheToStation_ReturnPath()
        {
            //Arrange
            var context = new InMemoryDB();
            ...
            //Act
            var result = sut.GetPathAsync("Station 1", "Station 5");
        ...
        [Fact]
        public void GetPathAsync_WhenTheStationsIsInTheSameLineAndTheFromStationIsAfterTheToStation_ReturnPath()
        {
            //Arrange
            var context = new InMemoryDB();
            ...
            //Act
            var result = sut.GetPathAsync("Station 4", "Station 2");
        ...
        [Fact]
        public void GetPathAsync_WhenTheFromStationIsTheToStation_ReturnFromStation()
        {
            //Arrange
            var context = new InMemoryDB();
            ...
            //Act
            var result = sut.GetPathAsync("Station 2", "Station 2");
